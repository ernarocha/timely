    ...
    <main className="relative grid min-h-screen place-items-center overflow-hidden bg-surface px-3 py-6 dark:bg-midnight sm:px-6 sm:py-10">
      ...
      <div className="relative grid w-full max-w-5xl items-center gap-10 lg:grid-cols-[1fr_460px]">
        <section className="hidden lg:block">
          ...
          <p className="font-mono text-xs uppercase tracking-[.18em] text-secondary dark:text-primary-container">
            {eyebrow}
          </p>
          <h1 className="mt-4 max-w-xl text-6xl font-bold leading-[.98] tracking-[-.045em] text-ink dark:text-white">
            {title}
          </h1>
        ...
        <Card className="relative p-5 sm:p-9">
          ...
          <p className="font-mono text-xs uppercase tracking-[.16em] text-secondary dark:text-primary-container">
            {formEyebrow}
          </p>
