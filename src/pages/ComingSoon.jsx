      ...
      <main className="mx-auto flex min-h-[calc(100vh-5rem)] w-full max-w-[1440px] items-center justify-center p-4 pb-24 sm:p-6 md:pb-6 lg:p-8">
        <Card className="relative w-full max-w-xl overflow-hidden p-8 text-center sm:p-12">
          ...
          <div className="relative">
            ...
            <p className="mt-6 inline-flex items-center gap-2 font-mono text-[10px] uppercase tracking-[.18em] text-secondary dark:text-primary-container"><Sparkles size={13} /> Coming soon</p>
            <h1 className="mt-3 text-3xl font-bold tracking-[-.03em] text-ink dark:text-white">{title} is on the way.</h1>
            <p className="mx-auto mt-3 max-w-md text-sm leading-6 text-muted dark:text-white/55 sm:text-base">{description}</p>
            <Button variant="soft" className="mt-7" onClick={() => navigate('/dashboard')}><ArrowLeft size={17} /> Back to dashboard</Button>
          </div>
        </Card>
      </main>
    </DashboardLayout>
