...
export default function Login() {
  ...
  return <AuthShell eyebrow="Welcome back" title="Make every hour count." copy="A calm, clear view of your week—so logging work never gets in the way of doing it." formEyebrow="Account access" formTitle="Sign in to TimeFrame" formCopy="Enter your details to continue to your workspace."><LoginForm /></AuthShell>
}

export function AuthShell({ eyebrow, title, copy, formEyebrow, formTitle, formCopy, children }) {
  return (
    <main className="relative grid min-h-screen place-items-center overflow-hidden bg-surface px-4 py-10 dark:bg-midnight sm:px-6">
      ...
      <div className="relative grid w-full max-w-5xl items-center gap-10 lg:grid-cols-[1fr_460px]">
        <section className="hidden lg:block">
          <div className="mb-10 flex items-center gap-3 text-xl font-extrabold"><span className="grid h-12 w-12 place-items-center rounded-2xl bg-ink text-primary-container dark:bg-primary-container dark:text-ink"><TimerReset /></span>TimeFrame</div>
        ...
        <Card className="relative p-6 sm:p-9">
          <div className="mb-7 lg:hidden"><div className="mb-6 flex items-center gap-3 text-xl font-extrabold"><span className="grid h-11 w-11 place-items-center rounded-2xl bg-ink text-primary-container dark:bg-primary-container dark:text-ink"><TimerReset size={22} /></span>TimeFrame</div></div>
